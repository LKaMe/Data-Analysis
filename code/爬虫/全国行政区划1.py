...
# 输出文件夹路径
out_dirs = 'data\\全国行政区划.csv'
#输出错误数据路径
out_dirs1 = 'data\\错误数据.csv'
...
def getQuanGuoCityUrl():
    ...
    try:
        ...
        write_csv(out_dirs1,["省错误:",city,code],'a+')
    # print("省：",urllist1)
    return urllist1
'''
        ...
        if isinstance(result,bs4.element.Tag):
            ...
            for level1 in level[3:]:
                try:
                    ...
                    write_csv(out_dirs1,["区县错误:",city2,code2],'a+')
    # print("区：",urllist3)
    return urllist3
'''
        ...
        if isinstance(result,bs4.element.Tag):
            ...
            for level1 in level[3:]:
                try:
                    ...
                    # print("下一个")
                    write_csv(out_dirs1,["乡镇错误:",city2,code2],'a+')
    # print("乡镇:",urllist4)
    return urllist4
        ...
        if isinstance(result,bs4.element.Tag):
            ...
            for level1 in level[3:]:
                try:
                    ...
                    write_csv(out_dirs,[city2,code2,fenlei],'a+')
                except:
                    # print("下一个")
                    write_csv(out_dirs1,["村错误:",city2,code2,fenlei],'a+')
